...
import {StyleSheet, Text, Image, View, Button, TextInput, ToastAndroid, AsyncStorage} from 'react-native';
    ...
    render() {
        ...
        return (
            <View>
                ...
                <Button title="Go to Jane's profile" onPress={() =>navigate('Detail', { name: 'Jane' })}/>
            </View>
        );
    }
}